    ...
    return (
        <>
            ...
            <section className={styles.container}>
                ...
                <ol>
                    <p>
                        Any information we get of a store is used for the only
                        purpose of comparing prices, we do not alter that
                        information and we have no influence over it as well.
                    </p>
                    <li>
                        <p>
