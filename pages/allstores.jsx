            ...
            <section className={styles.container}>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <p>
                            Digitallife into their terms conditions, under the Article 148 "fracción IV de la Ley Federal del Derecho de Autor - MX", determinate that any use of DIGITALIFE eCommerce information is under that article. The 148 Mexican Article allows "reproduction parts of the work, for criticism and scientific, literary or artistic research", for that reason Tech Deal use as Educational purpose the Doto App information locate into their page.
                            </p>
                    </li>
                    <li>
                        <p>
